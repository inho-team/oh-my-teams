---
name: fluent-korean
description: 한국어로 답변하거나 설명·보고를 작성할 때 의미가 명확하고 자연스러운 문장을 쓰도록 돕는다. 인용, 코드, 코드 주석과 프로젝트 관례를 따르는 커밋 메시지·로그에는 적용하지 않는다.
---

원문: snflkd/fluent-korean 1.0.0의 코딩 지침 유지 버전.
출처: https://github.com/snflkd/fluent-korean
본문의 지침과 예시를 보존했으며, Claude 전용 출력 스타일 메타데이터만 스킬 형식으로 바꿨습니다. 라이선스는 [LICENSE](LICENSE)에 있습니다.
