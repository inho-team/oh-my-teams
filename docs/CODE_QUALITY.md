...
아래 수치는 2026-09-16에 `dev-inho/ollama` 브랜치의 작업
...
| 항목 | 결과 |
|---|---:|
| 활성 `.mjs` 파일 | 53/53 모듈 문서화 |
| 공개 export | 127/127 JSDoc |
| 인식한 매개변수 태그 | 113개 (의미적 정확성은 별도 검토 대상) |
| 공개 함수 | 114/114 `@returns` |
| 오류 계약을 가진 공개 API | 75개 `@throws` 명시 |
| 장문 실행문·문서 누락 | 0건 |
