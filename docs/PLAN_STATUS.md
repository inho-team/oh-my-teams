...
| [oh my teams 이름 변경과 Orca 연동](plan/oh-my-teams-rename-and-orca-integration.md) | R0–R4 | package·marketplace·manifest의 기본 버전 1.5.0 일치, `plugins/orca` forwarding 진입점, Orca 1.4.200 discovery, 설치·CLI 회귀 테스트 | 이전 0.6.1은 rollback과 역사 보존 용도로만 유지한다. |
